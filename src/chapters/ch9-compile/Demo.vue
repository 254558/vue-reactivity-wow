      ...
      <div class="left-col">
        <div class="code-panel">
          <div class="code-header">
            ...
            <span class="code-filename">compiler.js</span>
...
const kw = ['let','const','var','function','return','if','else','while','new','true','false','null','this']
const types = ['AST','Context']
const fns = ['parse','parseInterpolation','parseElement','parseText','transform','traverseNode','generate','genNode','genElement','genInterpolation','genText','push','indent','deindent']
