      ...
      <div class="left-col">
        <div class="code-panel">
          <div class="code-header">
            ...
            <span class="code-filename">ref.js</span>
...
const types = ['WeakMap','Map','Set','Proxy','Object']
const fns = ['effect','track','trigger','reactive','ref','proxyRefs','defineProperty','Reflect']
